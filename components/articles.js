    ...
    <>
      ...
      <div className="PL__content">
        {articles.map((article) => (
          <div key={article.id} data-aos="zoom-in-up" className="px-4 md:px-0">
            <div className="relative flex max-w-[24rem] flex-col overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
              ...
              <div className="p-4 flex gap-2 flex-col justify-start items-start">
                <h4 className="block text-xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900" style={{ fontFamily: "Playfair Display" }}>
                  {article.title}
                </h4>
                <p className="block text-sm antialiased font-normal leading-relaxed text-gray-700 overflow-auto" style={{fontFamily: "Raleway"}}>
                  {article.description}
                </p>
