"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(a,b,c){c.d(b,{ET:function(){return hl},ad:function(){return gI},hJ:function(){return gG}});var d,e,f=c(5816),g=c(8463),h=c(3333),i=c(4444),j=c(3510),k=c(3454);let l="@firebase/firestore";/**
 * @license
 ...
 *   localWriteTime.
 */ function aE(a){var b,c;return"server_timestamp"===(null===(c=((null===(b=null==a?void 0:a.mapValue)|| void 0===b?void 0:b.fields)||{}).__type__)|| void 0===c?void 0:c.stringValue)}function aF(a){let b=aB(a.mapValue.fields.__local_write_time__.timestampValue);return new K(b.seconds,b.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let ch=new as(Q.comparator),ci=new as(Q.comparator);function cj(...a){let b=ci;for(let c of a)b=b.insert(c.key,c);return b}function ck(a){let b=ci;return a.forEach((a,c)=>b=b.insert(a,c.overlayedDocument)),b}function cl(){return cn()}function cm(){return cn()}function cn(){return new cg(a=>a.toString(),(a,b)=>a.isEqual(b))}let co=new as(Q.comparator),cp=new av(Q.comparator);function cq(...a){let b=cp;for(let c of a)b=b.add(c);return b}let cr=new av(H);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class cs{constructor(a,b,c,d,e){this.snapshotVersion=a,this.targetChanges=b,this.targetMismatches=c,this.documentUpdates=d,this.resolvedLimboDocuments=e}static createSynthesizedRemoteEventForCurrentChange(a,b){let c=new Map;return c.set(a,ct.createSynthesizedTargetChangeForCurrentChange(a,b)),new cs(L.min(),c,cr,ch,cq())}}class ct{constructor(a,b,c,d,e){this.resumeToken=a,this.current=b,this.addedDocuments=c,this.modifiedDocuments=d,this.removedDocuments=e}static createSynthesizedTargetChangeForCurrentChange(a,b){return new ct(az.EMPTY_BYTE_STRING,b,cq(),cq(),cq())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class dd extends null{constructor(a,b){super(),this.ie=a,this.currentSequenceNumber=b}}function de(a,b){var c;let d=c=a;return ae.O(d.ie,b)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class ef{constructor(a,b,c,d){this.remoteDocumentCache=a,this.mutationQueue=b,this.documentOverlayCache=c,this.indexManager=d}getDocument(a,b){let c=null;return this.documentOverlayCache.getOverlay(a,b).next(d=>(c=d,this.getBaseDocument(a,b,c))).next(a=>(null!==c&&b3(c.mutation,a,ay.empty(),K.now()),a))}getDocuments(a,b){return this.remoteDocumentCache.getEntries(a,b).next(b=>this.getLocalViewOfDocuments(a,b,cq()).next(()=>b))}getLocalViewOfDocuments(a,b,c=cq()){let d=cl();return this.populateOverlays(a,d,b).next(()=>this.computeViews(a,b,d,c).next(a=>{let b=cj();return a.forEach((a,c)=>{b=b.insert(a,c.overlayedDocument)}),b}))}getOverlayedDocuments(a,b){let c=cl();return this.populateOverlays(a,c,b).next(()=>this.computeViews(a,b,c,cq()))}populateOverlays(a,b,c){let d=[];return c.forEach(a=>{b.has(a)||d.push(a)}),this.documentOverlayCache.getOverlays(a,d).next(a=>{a.forEach((a,c)=>{b.set(a,c)})})}computeViews(a,b,c,d){let e=ch,f=cn(),g=cn();return b.forEach((a,b)=>{let g=c.get(b.key);d.has(b.key)&&(void 0===g||g.mutation instanceof b7)?e=e.insert(b.key,b):void 0!==g&&(f.set(b.key,g.mutation.getFieldMask()),b3(g.mutation,b,g.mutation.getFieldMask(),K.now()))}),this.recalculateAndSaveOverlays(a,e).next(a=>(a.forEach((a,b)=>f.set(a,b)),b.forEach((a,b)=>{var c;return g.set(a,new ee(b,null!==(c=f.get(a))&& void 0!==c?c:null))}),g))}recalculateAndSaveOverlays(a,b){let c=cn(),d=new as((a,b)=>a-b),e=cq();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(a,b).next(a=>{for(let e of a)e.keys().forEach(a=>{let f=b.get(a);if(null===f)return;let g=c.get(a)||ay.empty();g=e.applyToLocalView(f,g),c.set(a,g);let h=(d.get(e.batchId)||cq()).add(a);d=d.insert(e.batchId,h)})}).next(()=>{let f=[],g=d.getReverseIterator();for(;g.hasNext();){let h=g.getNext(),i=h.key,j=h.value,k=cm();j.forEach(a=>{if(!e.has(a)){let d=b1(b.get(a),c.get(a));null!==d&&k.set(a,d),e=e.add(a)}}),f.push(this.documentOverlayCache.saveOverlays(a,i,k))}return ac.waitFor(f)}).next(()=>c)}recalculateAndSaveOverlaysForDocumentKeys(a,b){return this.remoteDocumentCache.getEntries(a,b).next(b=>this.recalculateAndSaveOverlays(a,b))}getDocumentsMatchingQuery(a,b,c){var d;return(d=b,Q.isDocumentKey(d.path)&&null===d.collectionGroup&&0===d.filters.length)?this.getDocumentsMatchingDocumentQuery(a,b.path):by(b)?this.getDocumentsMatchingCollectionGroupQuery(a,b,c):this.getDocumentsMatchingCollectionQuery(a,b,c)}getNextDocuments(a,b,c,d){return this.remoteDocumentCache.getAllFromCollectionGroup(a,b,c,d).next(e=>{let f=d-e.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(a,b,c.largestBatchId,d-e.size):ac.resolve(cl()),g=-1,h=e;return f.next(b=>ac.forEach(b,(b,c)=>(g<c.largestBatchId&&(g=c.largestBatchId),e.get(b)?ac.resolve():this.getBaseDocument(a,b,c).next(a=>{h=h.insert(b,a)}))).next(()=>this.populateOverlays(a,b,e)).next(()=>this.computeViews(a,h,b,cq())).next(a=>({batchId:g,changes:ck(a)})))})}getDocumentsMatchingDocumentQuery(a,b){return this.getDocument(a,new Q(b)).next(a=>{let b=cj();return a.isFoundDocument()&&(b=b.insert(a.key,a)),b})}getDocumentsMatchingCollectionGroupQuery(a,b,c){let d=b.collectionGroup,e=cj();return this.indexManager.getCollectionParents(a,d).next(f=>ac.forEach(f,f=>{var g,h;let i=(g=b,h=f.child(d),new bs(h,null,g.explicitOrderBy.slice(),g.filters.slice(),g.limit,g.limitType,g.startAt,g.endAt));return this.getDocumentsMatchingCollectionQuery(a,i,c).next(a=>{a.forEach((a,b)=>{e=e.insert(a,b)})})}).next(()=>e))}getDocumentsMatchingCollectionQuery(a,b,c){let d;return this.remoteDocumentCache.getAllFromCollection(a,b.path,c).next(e=>(d=e,this.documentOverlayCache.getOverlaysForCollection(a,b.path,c.largestBatchId))).next(a=>{a.forEach((a,b)=>{let c=b.getKey();null===d.get(c)&&(d=d.insert(c,a5.newInvalidDocument(c)))});let c=cj();return d.forEach((d,e)=>{let f=a.get(d);void 0!==f&&b3(f.mutation,e,ay.empty(),K.now()),bF(b,e)&&(c=c.insert(d,e))}),c})}getBaseDocument(a,b,c){return null===c||1===c.mutation.type?this.remoteDocumentCache.getEntry(a,b):ac.resolve(a5.newInvalidDocument(b))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class eg{constructor(){this.overlays=new as(Q.comparator),this.es=new Map}getOverlay(a,b){return ac.resolve(this.overlays.get(b))}getOverlays(a,b){let c=cl();return ac.forEach(b,b=>this.getOverlay(a,b).next(a=>{null!==a&&c.set(b,a)})).next(()=>c)}saveOverlays(a,b,c){return c.forEach((c,d)=>{this.ue(a,b,d)}),ac.resolve()}removeOverlaysForBatchId(a,b,c){let d=this.es.get(c);return void 0!==d&&(d.forEach(a=>this.overlays=this.overlays.remove(a)),this.es.delete(c)),ac.resolve()}getOverlaysForCollection(a,b,c){let d=cl(),e=b.length+1,f=new Q(b.child("")),g=this.overlays.getIteratorFrom(f);for(;g.hasNext();){let h=g.getNext().value,i=h.getKey();if(!b.isPrefixOf(i.path))break;i.path.length===e&&h.largestBatchId>c&&d.set(h.getKey(),h)}return ac.resolve(d)}getOverlaysForCollectionGroup(a,b,c,d){let e=new as((a,b)=>a-b),f=this.overlays.getIterator();for(;f.hasNext();){let g=f.getNext().value;if(g.getKey().getCollectionGroup()===b&&g.largestBatchId>c){let h=e.get(g.largestBatchId);null===h&&(h=cl(),e=e.insert(g.largestBatchId,h)),h.set(g.getKey(),g)}}let i=cl(),j=e.getIterator();for(;j.hasNext()&&(j.getNext().value.forEach((a,b)=>i.set(a,b)),!(i.size()>=d)););return ac.resolve(i)}ue(a,b,c){let d=this.overlays.get(c.key);if(null!==d){let e=this.es.get(d.largestBatchId).delete(c.key);this.es.set(d.largestBatchId,e)}this.overlays=this.overlays.insert(c.key,new dh(b,c));let f=this.es.get(b);void 0===f&&(f=cq(),this.es.set(b,f)),this.es.set(b,f.add(c.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class em{constructor(a,b){this.Vs={},this.overlays={},this.Ss=new ao(0),this.Ds=!1,this.Ds=!0,this.referenceDelegate=a(this),this.Cs=new /**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function gx(a,b,c){if(!c)throw new w(v.INVALID_ARGUMENT,`Function ${a}() cannot be called with an empty ${b}.`)}function gy(a){if(!Q.isDocumentKey(a))throw new w(v.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${a} has ${a.length}.`)}function gz(a){if(Q.isDocumentKey(a))throw new w(v.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${a} has ${a.length}.`)}function gA(a){if(void 0===a)return"undefined";if(null===a)return"null";if("string"==typeof a)return a.length>20&&(a=`${a.substring(0,20)}...`),JSON.stringify(a);if("number"==typeof a||"boolean"==typeof a)return""+a;if("object"==typeof a){if(a instanceof Array)return"an array";{var b;let c=(b=a).constructor?b.constructor.name:null;return c?`a custom ${c} object`:"an object"}}return"function"==typeof a?"a function":u()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class gD{constructor(a,b,c){this.converter=b,this._key=c,this.type="document",this.firestore=a}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new gF(this.firestore,this.converter,this._key.path.popLast())}withConverter(a){return new gD(this.firestore,a,this._key)}}class gE{constructor(a,b,c){this.converter=b,this._query=c,this.type="query",this.firestore=a}withConverter(a){return new gE(this.firestore,a,this._query)}}class gF extends gE{constructor(a,b,c){super(a,b,bu(c)),this._path=c,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){let a=this._path.popLast();return a.isEmpty()?null:new gD(this.firestore,null,new Q(a))}withConverter(a){return new gF(this.firestore,a,this._path)}}function gG(a,b,...c){if(a=(0,i.m9)(a),gx("collection","path",b),a instanceof gC){let d=N.fromString(b,...c);return gz(d),new gF(a,null,d)}{if(!(a instanceof gD||a instanceof gF))throw new w(v.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let e=a._path.child(N.fromString(b,...c));return gz(e),new gF(a.firestore,null,e)}}class gH extends gC{constructor(a,b,c,d){super(a,b,c,d),this.type="firestore",this._queue=new /**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class gK{constructor(...a){for(let b=0;b<a.length;++b)if(0===a[b].length)throw new w(v.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new P(a)}isEqual(a){return this._internalPath.isEqual(a._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class gL{constructor(a){this._byteString=a}static fromBase64String(a){try{return new gL(az.fromBase64String(a))}catch(b){throw new w(v.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+b)}}static fromUint8Array(a){return new gL(az.fromUint8Array(a))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(a){return this._byteString.isEqual(a._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let gO=/^__.*__$/;class gP{constructor(a,b,c){this.data=a,this.fieldMask=b,this.fieldTransforms=c}toMutation(a,b){return null!==this.fieldMask?new b7(a,this.data,this.fieldMask,b,this.fieldTransforms):new b6(a,this.data,b,this.fieldTransforms)}}class gQ{constructor(a,b,c){this.data=a,this.fieldMask=b,this.fieldTransforms=c}toMutation(a,b){return new b7(a,this.data,this.fieldMask,b,this.fieldTransforms)}}function gR(a){switch(a){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw u()}}class gS{constructor(a,b,c,d,e,f){this.settings=a,this.databaseId=b,this.It=c,this.ignoreUndefinedProperties=d,void 0===e&&this.ea(),this.fieldTransforms=e||[],this.fieldMask=f||[]}get path(){return this.settings.path}get na(){return this.settings.na}sa(a){return new gS(Object.assign(Object.assign({},this.settings),a),this.databaseId,this.It,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ia(a){var b;let c=null===(b=this.path)|| void 0===b?void 0:b.child(a),d=this.sa({path:c,ra:!1});return d.oa(a),d}ua(a){var b;let c=null===(b=this.path)|| void 0===b?void 0:b.child(a),d=this.sa({path:c,ra:!1});return d.ea(),d}ca(a){return this.sa({path:void 0,ra:!0})}aa(a){return g5(a,this.settings.methodName,this.settings.ha||!1,this.path,this.settings.la)}contains(a){return void 0!==this.fieldMask.find(b=>a.isPrefixOf(b))|| void 0!==this.fieldTransforms.find(b=>a.isPrefixOf(b.field))}ea(){if(this.path)for(let a=0;a<this.path.length;a++)this.oa(this.path.get(a))}oa(a){if(0===a.length)throw this.aa("Document fields must not be empty");if(gR(this.na)&&gO.test(a))throw this.aa('Document fields cannot begin and end with "__"')}}class gT{constructor(a,b,c){this.databaseId=a,this.ignoreUndefinedProperties=b,this.It=c||e0(a)}fa(a,b,c,d=!1){return new gS({na:a,methodName:b,la:c,path:P.emptyPath(),ra:!1,ha:d},this.databaseId,this.It,this.ignoreUndefinedProperties)}}function gU(a){let b=a._freezeSettings(),c=e0(a._databaseId);return new gT(a._databaseId,!!b.ignoreUndefinedProperties,c)}function gV(a,b,c,d,e,f={}){let g=a.fa(f.merge||f.mergeFields?2:0,b,c,e);g1("Data must be an object, but it was:",g,d);let h=g_(d,g),i,j;if(f.merge)i=new ay(g.fieldMask),j=g.fieldTransforms;else if(f.mergeFields){let k=[];for(let l of f.mergeFields){let m=g2(b,l,c);if(!g.contains(m))throw new w(v.INVALID_ARGUMENT,`Field '${m}' is specified in your field mask but missing from your input data.`);g6(k,m)||k.push(m)}i=new ay(k),j=g.fieldTransforms.filter(a=>i.covers(a.field))}else i=null,j=g.fieldTransforms;return new gP(new a3(h),i,j)}class gW extends null{_toFieldTransform(a){if(2!==a.na)throw 1===a.na?a.aa(`${this._methodName}() can only appear at the top level of your update data`):a.aa(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return a.fieldMask.push(a.path),null}isEqual(a){return a instanceof gW}}function gX(a,b,c){return new gS({na:3,la:b.settings.la,methodName:a._methodName,ra:c},b.databaseId,b.It,b.ignoreUndefinedProperties)}class gY extends null{_toFieldTransform(a){return new bY(a.path,new bQ)}isEqual(a){return a instanceof gY}}function gZ(a,b,c,d=!1){return g$(c,a.fa(d?4:3,b))}function g$(a,b){if(g0(a=(0,i.m9)(a)))return g1("Unsupported field value:",b,a),g_(a,b);if(a instanceof gM)return function(a,b){if(!gR(b.na))throw b.aa(`${a._methodName}() can only be used with update() and set()`);if(!b.path)throw b.aa(`${a._methodName}() is not currently supported inside arrays`);let c=a._toFieldTransform(b);c&&b.fieldTransforms.push(c)}(a,b),null;if(void 0===a&&b.ignoreUndefinedProperties)return null;if(b.path&&b.fieldMask.push(b.path),a instanceof Array){if(b.settings.ra&&4!==b.na)throw b.aa("Nested arrays are not supported");return function(a,b){let c=[],d=0;for(let e of a){let f=g$(e,b.ca(d));null==f&&(f={nullValue:"NULL_VALUE"}),c.push(f),d++}return{arrayValue:{values:c}}}(a,b)}return function(a,b){if(null===(a=(0,i.m9)(a)))return{nullValue:"NULL_VALUE"};if("number"==typeof a)return bL(b.It,a);if("boolean"==typeof a)return{booleanValue:a};if("string"==typeof a)return{stringValue:a};if(a instanceof Date){let c=K.fromDate(a);return{timestampValue:cE(b.It,c)}}if(a instanceof K){let d=new K(a.seconds,1e3*Math.floor(a.nanoseconds/1e3));return{timestampValue:cE(b.It,d)}}if(a instanceof gN)return{geoPointValue:{latitude:a.latitude,longitude:a.longitude}};if(a instanceof gL)return{bytesValue:cF(b.It,a._byteString)};if(a instanceof gD){let e=b.databaseId,f=a.firestore._databaseId;if(!f.isEqual(e))throw b.aa(`Document reference is for database ${f.projectId}/${f.database} but should be for database ${e.projectId}/${e.database}`);return{referenceValue:cH(a.firestore._databaseId||b.databaseId,a._key.path)}}throw b.aa(`Unsupported field value: ${gA(a)}`)}(a,b)}function g_(a,b){let c={};return ar(a)?b.path&&b.path.length>0&&b.fieldMask.push(b.path):aq(a,(a,d)=>{let e=g$(d,b.ia(a));null!=e&&(c[a]=e)}),{mapValue:{fields:c}}}function g0(a){return!("object"!=typeof a||null===a||a instanceof Array||a instanceof Date||a instanceof K||a instanceof gN||a instanceof gL||a instanceof gD||a instanceof gM)}function g1(a,b,c){var d;if(!g0(c)||"object"!=typeof(d=c)||null===d||Object.getPrototypeOf(d)!==Object.prototype&&null!==Object.getPrototypeOf(d)){let e=gA(c);throw"an object"===e?b.aa(a+" a custom object"):b.aa(a+" "+e)}}function g2(a,b,c){if((b=(0,i.m9)(b))instanceof gK)return b._internalPath;if("string"==typeof b)return g4(a,b);throw g5("Field path arguments must be of type string or ",a,!1,void 0,c)}let g3=RegExp("[~\\*/\\[\\]]");function g4(a,b,c){if(b.search(g3)>=0)throw g5(`Invalid field path (${b}). Paths must not contain '~', '*', '/', '[', or ']'`,a,!1,void 0,c);try{return new gK(...b.split("."))._internalPath}catch(d){throw g5(`Invalid field path (${b}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,a,!1,void 0,c)}}function g5(a,b,c,d,e){let f=d&&!d.isEmpty(),g=void 0!==e,h=`Function ${b}() called with invalid data`;c&&(h+=" (via `toFirestore()`)"),h+=". ";let i="";return(f||g)&&(i+=" (found",f&&(i+=` in field ${d}`),g&&(i+=` in document ${e}`),i+=")"),new w(v.INVALID_ARGUMENT,h+a+i)}function g6(a,b){return a.some(a=>a.isEqual(b))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ class g7{constructor(a,b,c,d,e){this._firestore=a,this._userDataWriter=b,this._key=c,this._document=d,this._converter=e}get id(){return this._key.path.lastSegment()}get ref(){return new gD(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let a=new g8(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(a)}return this._userDataWriter.convertValue(this._document.data.value)}}get(a){if(this._document){let b=this._document.data.field(g9("DocumentSnapshot.get",a));if(null!==b)return this._userDataWriter.convertValue(b)}}}class g8 extends null{data(){return super.data()}}function g9(a,b){return"string"==typeof b?g4(a,b):b instanceof gK?b._internalPath:b._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * call.
 */ function hi(a,b,c){return a?c&&(c.merge||c.mergeFields)?a.toFirestore(b,c):a.toFirestore(b):b}function hj(a,b){if((a=getModularInstance(a)).firestore!==b)throw new w(v.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return a}class hk extends null{constructor(a){super(),this.firestore=a}convertBytes(a){return new gL(a)}convertReference(a){let b=this.convertDocumentKey(a,this.firestore._databaseId);return new gD(this.firestore,null,b)}}function hl(a,b){let c=function a(b,c){if("_delegate"in b&&(b=b._delegate),!(b instanceof c)){if(c.name===b.constructor.name)throw new w(v.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{let d=gA(b);throw new w(v.INVALID_ARGUMENT,`Expected type '${c.name}', but it was: ${d}`)}}return b}(a.firestore,gH),d=function(a,b,...c){if(a=(0,i.m9)(a),1===arguments.length&&(b=G.R()),gx("doc","path",b),a instanceof gC){let d=N.fromString(b,...c);return gy(d),new gD(a,null,new Q(d))}{if(!(a instanceof gD||a instanceof gF))throw new w(v.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let e=a._path.child(N.fromString(b,...c));return gy(e),new gD(a.firestore,a instanceof gF?a.converter:null,new Q(e))}}(a),e=hi(a.converter,b);return hm(c,[gV(gU(a.firestore),"addDoc",d._key,e,null!==a.converter,{}).toMutation(d._key,b$.exists(!1))]).then(()=>d)}function hm(a,b){var c;return function(a,b){let c=new x;return a.asyncQueue.enqueueAndForget(async()=>{var d;return fX(await (d=a,gu(d).then(a=>a.syncEngine)),b,c)}),c.promise}((c=a,c._firestoreClient||gJ(c),c._firestoreClient.verifyNotTerminated(),c._firestoreClient),b)}!function(a,b=!0){var c;n=f.Jn,(0,f.Xd)(new g.wA("firestore",(a,{instanceIdentifier:c,options:d})=>{let e=a.getProvider("app").getImmediate(),f=new gH(new A(a.getProvider("auth-internal")),new E(a.getProvider("app-check-internal")),function(a,b){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new w(v.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new aH(a.options.projectId,b)}(e,c),e);return d=Object.assign({useFetchStreams:b},d),f._setSettings(d),f},"PUBLIC").setMultipleInstances(!0)),(0,f.KN)(l,"3.4.15",void 0),(0,f.KN)(l,"3.4.15","esm2017")}()}}])